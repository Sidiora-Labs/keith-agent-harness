...
| You have | Go to |
| --- | --- |
| A setup, configuration, or usage question | [GitHub Discussions](https://github.com/Sidiora-Labs/keith-agent/discussions) |
| An idea or architecture proposal | [GitHub Discussions](https://github.com/Sidiora-Labs/keith-agent/discussions) |
| Reproducible behavior that should change | [Bug report](https://github.com/Sidiora-Labs/keith-agent/issues/new/choose) |
| A focused feature request | [Feature request](https://github.com/Sidiora-Labs/keith-agent/issues/new/choose) |
| A vulnerability or leaked credential | [Private security advisory](https://github.com/Sidiora-Labs/keith-agent/security/advisories/new) |
